...
def destination_language():
  print ("Enter the language on which you want to convert your voice")
  print()
...
while (to_lang not in dic):
  print("Language in which you are trying to convert\is currently unavailable ,please try some other language")
  print()
  to_lang= destination_language()
...
#transalting from stating to end
text_to_translate= translator.translate(query,dest=to_lang)
text= text_to_translate.text

#8 saving translated files and deleting them after playing
